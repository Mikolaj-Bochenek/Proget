...
echo Packing Proget.ORM.EntityFramework NuGet package...

dotnet pack ./src/Proget.ORM.EntityFramework/Proget.ORM.EntityFramework.csproj --configuration Release -p:PackageVersion=$version --output packages
